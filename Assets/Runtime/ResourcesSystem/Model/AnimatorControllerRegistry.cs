...
public class AnimatorControllerMapping
{
    ...
    public AssetReferenceT<RuntimeAnimatorController> animatorControllerReference;
...
{
    public List<AnimatorControllerMapping> mappings = new List<AnimatorControllerMapping>();

    private Dictionary<string, AssetReferenceT<RuntimeAnimatorController>> _dictReference;

#if UNITY_EDITOR
    private Dictionary<string, RuntimeAnimatorController> _dictEditor;
#endif
