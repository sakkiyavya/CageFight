...
/// <summary>
/// 通过玩家全局信息事件刷新当前物体上的金条数量文本。
/// </summary>
[DisallowMultipleComponent]
[RequireComponent(typeof(TextMeshProUGUI))]
public sealed class GoldBarInfoUI : MonoBehaviour
{
    ...
    private void SubscribeAndRefresh()
    {
        ...
        {
            Debug.LogError("[GoldBarInfoUI] UserGlobalInfo.Instance 为空，请确认场景中已挂载玩家全局信息单例。", this);
            return;
        }
    ...
    private void RefreshText()
    {
        ...
        _text.text = _subscribedInfo.GoldBarCount.ToString();
    }
    #endregion
}
