...
public class PrefabRegistry : ScriptableObject
{
    ...
    private Dictionary<string, AssetReferenceGameObject> _dictReference;

#if UNITY_EDITOR
    private Dictionary<string, GameObject> _dictEditor;
#endif
    ...
    /// <summary>
    /// 获取原始预制体引用 (仅在 UNITY_EDITOR 下有效，供编辑器同步免热更预览)
    /// </summary>
